...
export const emptyState = () => ({ revision: 0, accessRevision: 0, accessRequests: {}, gmAssignments: {}, games: structuredClone(SEED_GAMES), lineups: {}, rosters: structuredClone(INITIAL_ROSTERS), picks: structuredClone(INITIAL_PICKS), trades: structuredClone(HISTORICAL_TRADES) });

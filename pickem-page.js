loadLeagueData().then(data => {
  ...
  root.innerHTML = `
    <section class="card">
      ...
      <p class="muted">Sign in with Google, save your Real username, and pick the winner of each weekly matchup.</p>
      <div id="authBox"></div>
    </section>
  ...
  function renderUsernameSetup() {
    $('#usernameBox').innerHTML = `
      <section class="card" style="margin-top:16px">
        <h2 class="card-title">Real Username</h2>
        <p class="muted">This links your Google account to your Real username. One Google account gets one Pick'em entry per week.</p>
        <div class="grid two">

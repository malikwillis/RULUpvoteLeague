loadLeagueData().then(originalData => {
  ...
  root.innerHTML = `
    <section class="card">
      ...
      <p class="note">Player totals now come from game logs. This tool updates box scores and schedule scores, not roster upvote fields.</p>
    </section>
    ...
    <section class="card">
      ...
      <div class="row"><span>Fallback</span><strong>Download static-data.js and replace it manually</strong></div>
    </section>
  `;

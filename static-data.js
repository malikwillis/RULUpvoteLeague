window.RUL_STATIC_DATA = {
          ...
          "history": [
            {
              ...
              "from": "Vampires",
              "to": "Bandits",
              "title": "Vampires and Bandits trade"
            },
            {
              "week": "Rename",
        ...
        },
        {
          ...
          "history": [
            ...
            },
            {
              ...
              "from": "Bandits",
              "to": "Reapers",
              "title": "Bandits and Reapers trade"
            }
          ]
        }
      ],
  ...
  "draftBoard": [
    ...
    [
      "2",
      "Mammoths: realsabrinacarpenter",
      "Bandits: trentgrishamdadstrength",
      "Reapers: laddmcconkey15",
      "Angels: tan",
      "Mammoths: andthatsallshewrote",
      "Kitties: supaboiiii"
    ],
    [
      "3",
      "Vampires: seahawksfan1",
      "Bandits: flock.ravens",
      "Angels: cardinalsred123",
      "Vampires: cowan",
      "Phantoms: arachnid",
      "Kitties: gfkmoney"
    ],
    [
      "4",
      "Phantoms: kenunderrated",
      "Angels: kenny",
      "Phantoms: richer",
      "Reapers: dkbeefcake",
      "Kitties: mistermuyrico",
      "Reapers: sugashow_"
    ],
    [
      "5",
      "Reapers: ceedeelambfan",
      "Vampires: jaylen",
      "Reapers: j.hook",
      "Kitties: buxton_",
      "Voltage: thatboybuba",
    ...
    [
      "8",
      "Bandits: superbowl",
      "Vampires: thebaltimoreravens",
      "Reapers: derikqueenfan",
      "Mammoths: deletedacc",
      "Vampires: glazerofdrakemaye",
      "Mammoths: car.son"
    ]
  ],
  "records": [
    {
      "title": "All Time Upvotes",
      "items": [
        {
          "rank": 1,
          "player": "seahawksfan1",
    ...
    {
      "title": "Most Upvotes In A Season",
      "items": [
        {
          "rank": 1,
          "player": "seahawksfan1",
  ...
  "transactions": [
    {
      ...
      "date": "Week 6",
      "type": "Trade",
      "title": "Reapers acquire @glazerofdrakemaye",
      "teams": [
        "Bandits",
        "Reapers"
      ],
      ...
      "description": "Reapers acquire @glazerofdrakemaye from the Bandits. All existing game log stats stay with the same player profile."
    },
    {
      "week": "Week 5",
      "date": "Week 5",

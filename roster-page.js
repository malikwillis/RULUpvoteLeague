        ...
        <article class="card roster-card">
          <div class="roster-head">
            <div>
              ...
              <p class="muted">${escapeHtml(team.record || '0-0')} · ${escapeHtml(team.conferenceRecord || '0-0')} conf · ${fmt(team.totalUpvotes)} official upvotes</p>
            </div>
            <span class="pill">${filteredRoster.length || roster.length} Players</span>
          </div>
          ...
          <div class="roster-list">
            ${(filteredRoster.length ? filteredRoster : roster).map((player, index) => {
